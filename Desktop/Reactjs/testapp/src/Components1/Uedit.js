    ...
    <Grid item>
     ...
     <form noValidate>
      <Grid ml={1} container spacing={2}>
       <Grid item >
        <TextField autoComplete="userName" name="userName" variant="outlined" required fullWidth id="userName" label="userName" value={data.userName} onChange={e => textChange(e)}/>
       </Grid>
       <Grid item >
       ...
       <Grid item >
        <TextField autoComplete="storeCode" name="storeCode" variant="outlined" required fullWidth id="storeCode" label="StoreCode" value={data.storeCode} onChange={e => textChange(e)}/>
       </Grid>
       <Grid item >
        <TextField autoComplete="godownCode" name="godownCode" variant="outlined" required fullWidth id="godownCode" label="GodownCode" value={data.godownCode} onChange={e => textChange(e)}/>
       </Grid>
       <Grid item >
       ...
       <Grid item >
        <TextField autoComplete="contactNumber" name="contactNumber" variant="outlined" required fullWidth id="contactNumber" label="ContactNumber " value={data.contactNumber} onChange={e => textChange(e)} />
       </Grid>
       <Grid item >
       ...
       {/* <Grid item >
        <TextField autoComplete="password" name="password" variant="outlined" required fullWidth id="password" label="Password" value={data.password} onChange={e => textChange(e)}/>
       </Grid> */}
       <Grid item >
        <TextField autoComplete="userType" name="userType" variant="outlined" required fullWidth id="userType" label="UserType" value={data.userType} onChange={e => textChange(e)}/>
       </Grid>
      </Grid>
      <Grid item>
